      ...
      <form className="form">
        ...
        <div className="query-type-container">
          <label className="checkbox-label">
            <input type="radio" name="queryType" value="general" className="form-radio" required />
            General Enquiry
          </label>
          <label className="checkbox-label">
             <input type="radio" name="queryType" value="support" className="form-radio" required />
            Support Request
          </label>
        </div>
